...
class UR10eArm(object):
    ...
    def __init__(self):
        ...
        # initialize services
        move_arm_to_pose_goal_service = rospy.Service("move_arm_to_pose_goal", MoveArmToPoseGoal,
                                                      self.move_arm_to_pose_goal)
        move_arm_to_joints_state_service = rospy.Service("move_arm_to_joints_state", MoveArmToJointsState,
                                                         self.move_arm_to_joints_state)
