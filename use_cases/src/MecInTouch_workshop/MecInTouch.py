...
if __name__ == '__main__':
    ...
    manipulator.go_to_joint_state(1.97, -1.47, 0.84, -2.46, -2.35, -2.69, 0.2, 0.2)
    manipulator.go_to_joint_state(0.03, -0.69, 0.40, -0.80, -1.25, 0.75, 1, 0.2)
    hand.move(255, 255, 1)  # fechar gripper à max velocidade
    manipulator.go_to_joint_state(0.80, -0.50, 0.40, -1.70, 1.55, -0.11, 0.5, 0.2)
    hand.move(0, 255, 1)  # abrir gripper à max velocidade
    manipulator.go_to_joint_state(-0.69, -0.80, 1.09, -0.08, -0.47, 0.03, 0.2, 0.2)
    print("\nCheguei!! :D\n")
