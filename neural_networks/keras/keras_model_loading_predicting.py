...
def save_txt_file(matrix, action, output):
    ...
    if output:
        ...
        with open(ROOT_DIR + "/neural_networks/keras/predicted_data/output_predicted_" + action + ".txt",
                  'wb') as output_f:
...
if __name__ == '__main__':
    ...
    plt.savefig(ROOT_DIR + "/neural_networks/keras/predicted_data/pull_output_confidences.png", bbox_inches='tight')
    ...
    plt.savefig(ROOT_DIR + "/neural_networks/keras/predicted_data/push_output_confidences.png", bbox_inches='tight')
    ...
    plt.savefig(ROOT_DIR + "/neural_networks/keras/predicted_data/shake_output_confidences.png", bbox_inches='tight')
    ...
    plt.savefig(ROOT_DIR + "/neural_networks/keras/predicted_data/twist_output_confidences.png", bbox_inches='tight')
