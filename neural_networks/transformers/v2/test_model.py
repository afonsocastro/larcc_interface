...
if __name__ == '__main__':
    ...
    transformer_v2_1 = keras.models.load_model("transformer_v2_1.keras")
    model_name = "transformer_v2_1"
    ...
    for i in range(0, len(test_data_1)):
        prediction = transformer_v2_1.predict(x=x_test[i:i + 1, :, :, :], verbose=0)
