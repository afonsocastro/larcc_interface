...
if __name__ == '__main__':
    ...
    for transformer_model_olarilole in models:
        ...
        # for n in track(range(n_times), total=n_times):
            ...
            x_train = x_train[:, :, 1:]
            if transformer_model_olarilole == "model_v1_1":
                model, model_name = create_transformer_v1_1()
            elif transformer_model_olarilole == "model_v1_2":
                model, model_name = create_transformer_v1_2()
            elif transformer_model_olarilole == "model_v1_3":
                model, model_name = create_transformer_v1_3()
            elif transformer_model_olarilole == "model_v1_4":
                model, model_name = create_transformer_v1_4()
            elif transformer_model_olarilole == "model_v1_5":
